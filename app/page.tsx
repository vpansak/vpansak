  ...
  return (
    <main className="vp-store">
      ...
      {announcementOpen && <div className="vp-topbar vp-offer-announcement">
        ...
        <p><strong>Extra 10% off your first VPANSAK order</strong><small>Maximum discount ₹300 • Minimum cart value applies</small></p>
        <button type="button" className="vp-announcement-code" onClick={() => { navigator.clipboard?.writeText("VPANSAK10"); notify("Coupon code copied"); }}><small>USE CODE</small><strong>VPANSAK10</strong><i>Copy</i></button>
