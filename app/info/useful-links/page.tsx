...
export default function UsefulLinksPage() {
  ...
  const quickButtons = [
    ...
    { title: "Direct Brand Guarantee", badge: "100% D2C", badgeClass: "merchant-badge", icon: ShieldCheck, desc: "100% Genuine products, zero 3rd-party sellers.", link: "/seller" },
    { title: "Copyright & IP Notice", badge: "LEGAL", badgeClass: "portal-badge", icon: Briefcase, desc: "50-Section Brand & Intellectual Property terms.", link: "/policies/copyright-terms" },
  ...
  const linkCategories = [
    ...
    {
      title: "Brand Governance & Community",
      icon: ShieldCheck,
      links: [
        { name: "VPANSAK Direct Brand Policy", desc: "100% Genuine Direct D2C Store guarantee", href: "/seller" },
        { name: "Brand Quality SLA", desc: "Quality standards & zero 3rd-party sellers", href: "/policies/merchant-guidelines" },
        { name: "Copyright & IP Protection Notice", desc: "Comprehensive brand & copyright terms", href: "/policies/copyright-terms" },
