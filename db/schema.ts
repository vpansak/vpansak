...
export const careerApplications = sqliteTable("career_applications", {
  ...
  interestedRole: text("interested_role").notNull(),
  ...
  resumeFileRef: text("resume_file_ref"),
  source: text("source").notNull().default("VPANSAK Website"),
  sourceOther: text("source_other"),
  whyVpansak: text("why_vpansak"),
  careerGoals: text("career_goals"),
  availability: text("availability").notNull().default("Immediately"),
  interviewAvailability: text("interview_availability").notNull().default("Yes"),
  expectedCompensation: text("expected_compensation"),
  referral: text("referral").notNull().default("No"),
